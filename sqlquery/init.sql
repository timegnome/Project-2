...
CREATE TABLE merged_rpg (datetime DATE, players BIGINT, twitchviewers BIGINT);
...
CREATE TABLE merged_platformer (datetime DATE, players BIGINT, twitchviewers BIGINT);
...
CREATE TABLE merged_fps (datetime DATE, players BIGINT, twitchviewers BIGINT);
...
CREATE TABLE merged_sports (datetime DATE, players BIGINT, twitchviewers BIGINT);
...
CREATE TABLE merged_strategy (datetime DATE, players BIGINT, twitchviewers BIGINT);
